...
**NoSuffocationOverlay** is a lightweight client-side mod for **Fabric 1.21.6+** that allows you to either remove or change the opacity of the block overlay when your head is inside a block.
